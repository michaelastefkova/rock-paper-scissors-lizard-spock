...
import { ShapeContainer } from '../styledComponents/ShapeContainer';

export default function Spock(props) {
  const { secondRendering, gameOn } = props
  console.log(props)
  return (
    <ShapeContainer shape="spock"
      onClick={secondRendering ? null : () => props.handleClick('spock')}
      gameOn={gameOn}
    >
      <div class="image">
